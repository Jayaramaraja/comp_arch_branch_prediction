...
BTBEntriesValue=['16','128','1024']
#BTBEntriesValue=['2048','8192','32768']
localPredictorValue=['1024']
globalPredictorValue=['16','512','1024','8192','32768']
choicePredictorValue=['16','512','1024','8192','32768']
				...
				for choice_var in choicePredictorValue:
					...
					for index in range(len(test_name)):
						for number in range(len(l1dsize_set)):
							final_out_dir = str(output_dir[index])+'/'+str(bp_var)+'_'+str(test_true_name[index])+'_'+str(BTB_var)+'BTBEntries_'+str(global_var)+'global_'+str(choice_var)+'choice'
